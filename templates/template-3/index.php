        ...
        <div class="container">
            <div class="cta-content">
                ...
                <div class="cta-actions">
                    <!-- WhatsApp Button -->
                    <a href="https://wa.me/966550698111?text=مرحباً، أود الاستفسار عن خدماتكم" class="btn btn-light"
            ...
            if (!modal) {
                ...
                modal.innerHTML = `
                    ...
                    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 100%; padding: 40px 20px;">
                        ...
                        <a id="modal-cta" href="https://wa.me/966550698111?text=مرحباً، أود الاستفسار عن هذا المشروع" target="_blank" style="margin-top: 1.5rem; background: #25D366; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; font-weight: 600;">
