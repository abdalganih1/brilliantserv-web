        ...
        "@graph": [
            {
                ...
                "image": [
                    "https://brilliantserv.com/media/hero-electrical-work.png",
                    "https://brilliantserv.com/media/hero-mechanic-pumps.png",
                    "https://brilliantserv.com/media/hero-motor-winding.png"
                ],
            ...
            },
            {
                ...
                "primaryImageOfPage": {
                    "@type": "ImageObject",
                    "url": "https://brilliantserv.com/media/hero-electrical-work.png"
                },
        ...
        <div class="container">
            ...
            <div class="projects-grid" style="grid-template-columns: repeat(4, 1fr);">
                <div class="project-card">
                    <img src="media/electrical/p17_img4.jpeg" alt="أعمال كهربائية" loading="lazy">
                ...
                <div class="project-card">
                    <img src="media/mechanical/p9_img4.jpeg" alt="أعمال ميكانيكية" loading="lazy">
                    <div class="project-overlay">
                ...
                <div class="project-card">
                    <img src="media/electrical/p21_img4.jpeg" alt="أعمال كهربائية" loading="lazy">
                    <div class="project-overlay">
                ...
                <div class="project-card">
                    <img src="media/mechanical/p10_img4.jpeg" alt="أعمال ميكانيكية" loading="lazy">
                    <div class="project-overlay">
                ...
                <div class="project-card">
                    <img src="media/electrical/p18_img4.jpeg" alt="أعمال كهربائية" loading="lazy">
                    <div class="project-overlay">
                ...
                <div class="project-card">
                    <img src="media/mechanical/p11_img4.jpeg" alt="أعمال ميكانيكية" loading="lazy">
                    <div class="project-overlay">
                ...
                <div class="project-card">
                    <img src="media/electrical/p23_img4.jpeg" alt="أعمال كهربائية" loading="lazy">
                    <div class="project-overlay">
                ...
                <div class="project-card">
                    <img src="media/mechanical/p12_img4.jpeg" alt="أعمال ميكانيكية" loading="lazy">
                    <div class="project-overlay">
                        <h4>محطات ضخ مياه</h4>
                        <span>أعمال ميكانيكية</span>
                    </div>
            ...
            <div class="swiper references-swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/12.png" alt="مرجع 1"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/13.png" alt="مرجع 2"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/14.png" alt="مرجع 3"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/15.png" alt="مرجع 4"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/16.png" alt="مرجع 5"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/17.png" alt="مرجع 6"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/18.png" alt="مرجع 7"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/19.png" alt="مرجع 8"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/20.png" alt="مرجع 9"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/21.png" alt="مرجع 10"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/22.png" alt="مرجع 11"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/23.png" alt="مرجع 12"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/24.png" alt="مرجع 13"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/25.png" alt="مرجع 14"
                                loading="lazy"></div>
                    </div>
                    <div class="swiper-slide">
                        <div class="client-logo"><img src="../../ملفات المستخدم/مراجعنا/26.png" alt="مرجع 15"
                                loading="lazy"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="services-grid" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem;">
                ...
                <article class="service-card" style="text-align: right; padding: 0; overflow: hidden;">
                    <img src="../../media/hero-mechanic-pumps.png" alt="كشف تسربات"
                ...
                <!-- Blog Card 3 -->
                <article class="service-card" style="text-align: right; padding: 0; overflow: hidden;">
                    <img src="../../media/about-team-work.png" alt="عزل اسطح"
                        style="width: 100%; height: 200px; object-fit: cover;">
                    <div style="padding: 1.5rem;">
                        <span
