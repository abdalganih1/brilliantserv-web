    ...
    <div class="container">
        <div class="footer-grid">
            <div class="footer-brand">
                ...
                <p>مؤسسة رائدة في مجال المقاولات الكهروميكانيكية، نسعى دائماً لتقديم أفضل الخدمات والحلول المبتكرة
                    لعملائنا.</p>
                <div class="social-links">
                    ...
                    <a href="<?= $social_youtube ?>" target="_blank" aria-label="YouTube">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                            fill="currentColor">
                            <path
            ...
            <div class="footer-links">
                <h4>روابط سريعة</h4>
                <ul>
                    <li><a href="<?= $base_path ?>index.php">الرئيسية</a></li>
                    <li><a href="<?= $base_path ?>about.php">من نحن</a></li>
                    <li><a href="<?= $base_path ?>projects.php">أعمالنا</a></li>
                    <li><a href="<?= $base_path ?>services.php">خدماتنا</a></li>
                </ul>
            </div>
            <div class="footer-links">
                <h4>تواصل معنا</h4>
                <ul>
                    <li><a href="<?= $base_path ?>contact.php">اتصل بنا</a></li>
                    <li><a href="<?= $base_path ?>blog.php">المدونة</a></li>
                </ul>
            </div>
